...
library(knitr)
library(htmltools)
# rmarkdown::render("./R/index.Rmd", output_dir="./docs",
#   output_options=c("use_xhtml","smartypants", "highlight_code"))
...
Easy access to RFE v2.0 and CHIRPSv2 long-term (20-year) precipitation time-series for Africa.

https://data.worldcovr.com/shiny/bio-data/
