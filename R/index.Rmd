...
### <big>Simulating Historical Claim Costs</big> Agricultural Index Insurance

```{r}

include_graphics("../assets/mbacou-app-pricing.png")
...
<u>Tools</u>  
R/Shiny, shinydashboardPlus, shinWidgets, data.table, leaflet, highcharter

### <big>Tracking Insurance Servicing</big> Agricultural Index Insurance

```{r}

include_graphics("../assets/mbacou-app-servicing.png")
...
### <big>Long-Term Rainfall Time-Series</big> for Africa
